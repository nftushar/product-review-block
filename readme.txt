...
**[Demos](https://bblockswp.com/demo/product-review/)**
...
= How to use =
- First, install the product-review plugin
- Add the product-review block from the block category called "Widgets" in the Gutenberg editor.
...
2. Search For **product-review**
3. Click on the **product-review** to add the block

= Download & Upload: =
1. Download the **product-review** plugin (*.zip file*)
2. In your admin area, go to the Plugins menu and click on **Add New**
3. Click on **Upload Plugin** and choose the **`product-review.zip`** file and click on **Install Now**
4. Activate the plugin and Enjoy!

= Manually: =
1. Download and upload the **product-review** plugin to the **`/wp-content/plugins/`** directory
2. Activate the plugin through the Plugins menu in WordPress


== Frequently Asked Questions ==

= Is product-review free? =

Yes, product-review is a free Gutenberg block plugin.
...
You can post your questions on the [support forum here](https://wordpress.org/support/plugin/product-review/)
