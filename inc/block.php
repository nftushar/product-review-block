...
class PRBBlock{
	...
	function onInit() {
		wp_register_style( 'b-product-review-style', plugins_url( 'dist/style.css', __DIR__ ), [], B_BLOCKS_VERSION); // Style
		...
		wp_set_script_translations( 'b-blocks-product-review-editor-script', 'product-review', plugin_dir_path( __DIR__ ) . 'languages' ); // Translate
	}
